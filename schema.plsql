...
insert into ChiTieu (maChiTieu ,tenChiThi ,soTien ,duAN) values('CT001', 'Coming to the best', 2131, 'DA001');
insert into ChiTieu (maChiTieu ,tenChiThi ,soTien ,duAN) values('CT002', 'Road into bounus', 5654, 'DA002');
insert into ChiTieu (maChiTieu ,tenChiThi ,soTien ,duAN) values('CT003', 'Never land', 6765, 'DA003');
insert into ChiTieu (maChiTieu ,tenChiThi ,soTien ,duAN) values('CT004', 'Check point in the Code', 1254, 'DA004');
insert into ChiTieu (maChiTieu ,tenChiThi ,soTien ,duAN) values('CT005', 'Never hope back', 8987, 'DA005');
